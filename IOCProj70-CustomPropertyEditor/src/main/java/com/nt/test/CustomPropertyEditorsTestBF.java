...
public class CustomPropertyEditorsTestBF {
	...
	public static void main(String[] args) {
		...
		factory.addPropertyEditorRegistrar(new CustomeRegistar());
		// get PersonInfo class object
		lcalc = factory.getBean("lacalc", LoanAmntCalculator.class);
		System.out.println(lcalc.getIntrestAmnt());
	}

	// register CustomeRegistar in ProoertyEditorRegistar
	private static class CustomeRegistar implements PropertyEditorRegistrar {
