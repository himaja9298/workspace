...
public class BankServiceImpl implements BankService {
	...
	@Override
	 ...
	 // @Transactional(propagation=Propagation.REQUIRED,transactionManager="dsTxMgmr")-->it is not recommended
	public String trasferMoney(double srcactno, double destactno, float amnt) {
		...
		if (count1 == 0 || count2 == 0)
			...
			//throw new IllegalArgumentException("problem in money transfering");
		else
